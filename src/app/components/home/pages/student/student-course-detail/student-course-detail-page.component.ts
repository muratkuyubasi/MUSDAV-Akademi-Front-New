...
@Component({
    selector: 'app-student-course-detail-page',
    templateUrl: './student-course-detail-page.component.html',
    styleUrls: ['./student-course-detail-page.component.scss'],
})
export class StudentCourseDetailPageComponent extends BaseComponent implements OnInit,OnDestroy {
    ...
    ngOnInit() {
        this.sub$.sink = this.activeRoute.data.subscribe(
            (data: { studentCourse: any }) => {
              if (data.studentCourse) {
                this.course = data.studentCourse.data;
                

                console.log("Öğrenci Kursu",this.course)
