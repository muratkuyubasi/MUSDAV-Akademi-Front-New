...
@Component({
    selector: 'app-student-synchron',
    templateUrl: 'synchron-course.component.html',
    styleUrls:['../student-course-detail/student-course-detail-page.component.scss']
})

export class StudentSynchronCourseComponent extends BaseComponent implements OnInit {
    @Input() course:any;
