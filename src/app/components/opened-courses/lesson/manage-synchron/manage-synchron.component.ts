...
@Component({
    selector: 'app-manage-synchron',
    templateUrl: 'manage-synchron.component.html'
})

export class ManageSynchronCourseDetailComponent extends BaseComponent implements OnInit {
    @Input() course:any;
    @Input() section:any;
    ...
    saveLessons(){
      ...
      console.log("DErsler",this.lessonDays);
