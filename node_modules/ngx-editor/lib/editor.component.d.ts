...
export declare class NgxEditorComponent implements ControlValueAccessor, OnInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NgxEditorComponent, "ngx-editor", never, { "editor": "editor"; "outputFormat": "outputFormat"; "placeholder": "placeholder"; }, { "focusOut": "focusOut"; "focusIn": "focusIn"; }, never, ["*"], false>;
}
