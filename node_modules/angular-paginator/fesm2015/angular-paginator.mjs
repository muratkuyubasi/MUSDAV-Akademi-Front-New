    ...
    updateInstance(instance) {
        ...
        for (const [k, v] of Object.entries(instance)) {
            ...
            if (key !== 'id'
                && currentInstance[k] !== v
                && !updated) {
                this.instances[instance.id] = Object.assign(Object.assign({}, instance), { id: instance.id });
                updated = true;
            }
        }
        return updated;
...
AngularPaginatorPipe.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.0.4", ngImport: i0, type: AngularPaginatorPipe, deps: [{ token: AngularPaginatorService }], target: i0.ɵɵFactoryTarget.Pipe });
...
AngularPaginatorDirective.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.0.4", ngImport: i0, type: AngularPaginatorDirective, deps: [{ token: AngularPaginatorService }], target: i0.ɵɵFactoryTarget.Directive });
...
AngularPaginatorModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.0.4", ngImport: i0, type: AngularPaginatorModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
AngularPaginatorModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.0.4", ngImport: i0, type: AngularPaginatorModule, declarations: [AngularPaginatorPipe, AngularPaginatorDirective], imports: [CommonModule], exports: [AngularPaginatorDirective, AngularPaginatorPipe] });
AngularPaginatorModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.0.4", ngImport: i0, type: AngularPaginatorModule, providers: [AngularPaginatorService], imports: [CommonModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.0.4", ngImport: i0, type: AngularPaginatorModule, decorators: [{
            type: NgModule,
            args: [{
...
//# sourceMappingURL=angular-paginator.mjs.map
