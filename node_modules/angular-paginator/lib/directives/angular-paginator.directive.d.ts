...
import { Page } from '../others/angular-paginator.interface';
...
export declare class AngularPaginatorDirective implements OnInit, OnDestroy {
    ...
    ngOnInit(): void;
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<AngularPaginatorDirective, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<AngularPaginatorDirective, "angularPaginator, [angularPaginator]", ["angularPaginator"], { "id": "id"; "maxSize": "maxSize"; "rotate": "rotate"; "boundaryLinkNumbers": "boundaryLinkNumbers"; "forceEllipses": "forceEllipses"; }, { "pageChange": "pageChange"; }, never, never, false, never>;
}
